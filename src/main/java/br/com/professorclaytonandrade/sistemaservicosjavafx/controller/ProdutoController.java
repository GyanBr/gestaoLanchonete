...
public class ProdutoController {
    ...
    @FXML
    private TableView<Object> produtosTable;
    ...
    private ObservableList<Object> listaProdutos = FXCollections.observableArrayList();
    ...
    private void handleExcluir(ActionEvent event) {
        Object produtoSelecionado = produtosTable.getSelectionModel().getSelectedItem();
